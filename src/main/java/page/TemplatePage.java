...
/*
 * This class explains about Template screen functionality
 */
public class TemplatePage extends GlobalFunctions {
	Logger log = LogManager.getLogger(TemplatePage.class);
