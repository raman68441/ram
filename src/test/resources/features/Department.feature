...
Feature: Department functionality
  ...
  Scenario: 1_verify department functionality
   ...
   # Then User verify 'label department name' in department page
    ...
    Then User verify 'label business unit' in department page
    Then User verify 'label department description' in department page
    Then User verify 'cancel' button in department page
    Then User verify 'save button' in department page
    And User clicks on 'save' button in department page
    ...
    Then User verify 'warning message please select business unit' in department page
    ...
    And User selects 'text department business unit' as 'business unit' in department page
   ...
   # Then User verify 'label department name' in department page
    Then User verify 'label department code' in department page
    Then User verify 'label edit business unit' in department page
    Then User verify 'label department description' in department page
    And User clicks on 'cancel' button in department page
    And User clicks on 'edit' icon in department page
    Then User verify 'edit department header' in department page
    ...
    Then User verify 'label edit business unit' in department page
    Then User verify 'label department description' in department page
    Then User enters 'text odepartment name1' in 'edit department name' field of department page
    Then User enters 'text department code1' in 'department code' field of department page
    And User selects 'text department business unit1' as 'business unit' in department page
        Then User enters 'text department description1' in 'description' field of department page
    ...
    Then User verify 'confirm you delete' in department page
