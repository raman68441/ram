...
Feature: Numbering System functionality
  ...
  @numberingSystem
  Scenario: 1_verify create, update and delete functionality of Numbering System 
    ...
    Then User clicks on 'reset filter' button in numbering system page
    Then User verify 'table filter default value' in numbering system page
    Then User verify 'search option default value' in numbering system page 
    And User selects 'name option' as 'search option' in numbering system page
    Then User enters 'text numbering system name' in 'search' field of numbering system page
    Then User verify 'txt_numbering_system_table_data' in row 1 of numbering system page
    And User selects 'description option' as 'search option' in numbering system page
    Then User enters 'text numbering system description' in 'search' field of numbering system page
    And User verify 'text numbering system description' in row 1 column 3 in numbering page
     And User clicks on 'reset filter' button in numbering system page
    Then User verify 'search option default value' in numbering system page
    Then User verify 'table filter default value' in numbering system page
    And User clicks on 'new numbering system' in numbering system page
    ...
    And User clicks on 'add' button in numbering system page
    And User clicks on 'generate' button in numbering system page
    Then User verify 'numbering system already exist message' in numbering system page
    And User clicks on 'cancel' button in numbering system page
    ...
    Then User verify 'edit numbering system header' in numbering system page
    Then User verify 'label name field' in numbering system page
    Then User enters 'text edit numbering system name' in 'edit name' field of numbering system page
